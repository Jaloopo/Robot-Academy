...
window.KAPITEL["kapitel-1"] = {
  ...
  "steps": [
    ...
    },
    {
      "role": "child",
      "type": "text",
      "text": "Edison kan köra framåt och bakåt, känna av ljus, höra ljud och se hinder framför sig. Två Edison-robotar kan till och med prata med varandra med osynligt ljus."
    },
    {
      "role": "child",
      "type": "text",
