...
window.KAPITEL["kapitel-1"] = {
  ...
  "steps": [
    ...
    { "role": "child", "type": "image",
      "src": "./assets/edison-knappar.svg",
      "alt": "Tre knappar i rad: en rund knapp, en triangel-knapp för play och en fyrkant-knapp för stopp.",
      "text": "Titta på knapparna: en rund, en med en triangel (play) och en med en fyrkant (stopp)." },
